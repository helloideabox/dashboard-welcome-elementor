...
module.exports = function( grunt ) {
	...
	const pluginName = 'dashboard-welcome-for-elementor';
	const textDomain = 'dashboard-welcome-for-elementor';
	...
	grunt.initConfig({
		...
		addtextdomain: {
			options: {
				...
				updateDomains: [ 'ibx-dwe', 'powerpack', 'power-pack', 'bb-powerpack', 'elementor']  // List of text domains to replace.
			},
			target: {
				files: {
					src: [
		...
		replace: {
			main: {
				src: ['dashboard-welcome-elementor.php'],
				overwrite: true,
				replacements: [
					{
